var storeList = ['Fareway', 'Ace Hardware', 'Caseys', 'The Hatchery', 'Amundsens']
var sectionList = ['Produce', 'Meats', 'Cereal', 'Canned Goods', 'Frozen Foods', 'Dairy', 'Liquor', 'Tools', 'Clothing']
...
$(document).ready(function () {
    populateSelect('store', storeList)
    populateSelect('category', sectionList)
})
